                ...
                <h6 class="mb-4">{{ __('Register') }}</h6>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group has-float-label mb-4">
                            <label for="name" class="form-group has-float-label mb-4">{{ __('Name') }}</label>
                        ...
                        <div class="form-group has-float-label mb-4">
                            <label for="password-confirm" class="form-group has-float-label mb-4">{{ __('Confirm Password') }}</label>
